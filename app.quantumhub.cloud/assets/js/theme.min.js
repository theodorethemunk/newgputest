                            ...
                            external: function(e) {
                                ...
                                if (i.classList.remove("above", "below", "no-transform"), e.tooltip.yAlign ? i.classList.add(e.tooltip.yAlign) : i.classList.add("no-transform"), e.tooltip.body) {
                                    var o = e.tooltip.title || [],
                                        ...
                                        s = '<header class="hs-chartjs-tooltip-header">';
                                    o.forEach((t => {
                                        s += this.options.yearStamp ? t + ", " + this.options.yearStamp || l.getFullYear() : t
            ...
            for (let e = 0; e < i.collection.length; e += 1) {
                ...
                i.collection[e].$initializedEl.on("success", (() => {
                    if (o.successText || o.successClass) {
                        if (o.successText && ("tooltip" === o.type ? (n.setAttribute("data-bs-original-title", o.successText), o.instanceTooltip.setContent(), n.addEventListener("mouseleave", l)) : "popover" === o.type ? (t.setAttribute("data-bs-original-title", o.successText), o.instancePopover.show(), n.addEventListener("mouseleave", (() => {
            ...
            e = Object.assign({
                ...
                options: Object.assign({}, e, {
                    ...
                    text: i => {
                        ...
                        return o.contentTarget && this.setShortcodes(t, e), e.shortcodes[o.contentTarget] || t.getAttribute("data-clipboard-text")
                    }
                })
            })
        },
